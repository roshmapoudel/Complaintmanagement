 ...
 */
if (isset($_POST['u_complaint']) && isset($_POST['u_faculty']) && isset($_POST['u_name']) && isset($_POST['u_age']) && isset($_POST['u_email'])) :
	...
	$complaint = $_POST ['u_complaint'];
	$faculty = $_POST ['u_faculty'];
    $name = $_POST['u_name'];
    $age = $_POST['u_age'];
    $email = $_POST['u_email'];

    # SQL query for Inserting the Form Data into the users table.
    $sql = "INSERT INTO `users` (`complaint`, `faculty`, `name`, `age`, `email`) VALUES ('$complaint', '$faculty', '$name', $age, '$email')";
